...
local function getClosedTarget(player, cid, targets)
    ...
    if c then
        ...
        local spectators = Game.getSpectators(c:getPosition(), false, false, distanceToBounce, distanceToBounce, distanceToBounce, distanceToBounce)
...
spell:name("Chain Vis")
spell:words("exevo vis mas")
spell:group("attack")
