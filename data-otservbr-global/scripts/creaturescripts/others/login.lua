...
function playerLogin.onLogin(player)
	...
	local defaultTown = "Armonia" -- default town where player is teleported if his home town is in premium area
	local freeTowns = { "Armonia" } -- towns in free account area
